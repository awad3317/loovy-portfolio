        ...
        <div class="row align-items-center">
            <div class="col-lg-6 intro-text text-lg-start text-center" data-aos="fade-left" data-aos-duration="800"
                ...
                <p class="mt-3 mb-4 text-secondary">
                    نفخر بريادتنا في مجال الصناعات الصحية من خلال تقديم منتجات آمنة وموثوقة، مصنعة وفق أحدث التقنيات وبأعلى معايير الجودة العالمية. نضع صحة وراحة عملائنا في صدارة أولوياتنا، ونسعى باستمرار إلى الابتكار والتطوير لنكون الخيار الأول للعائلات في كل مكان.
                </p>
