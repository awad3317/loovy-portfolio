                ...
                <div class="col-sm-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card shadow-sm h-100 border-0 rounded-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-muted">
                                نعمل بشكل دائم على تطوير المنتجات من خلال فرق بحث وتطوير متخصصة، لنقدم حلولاً تناسب
                                تطلعات
                                المستهلك الحديث.
                            </p>
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card shadow-sm h-100 border-0 rounded-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-muted">
                                نمتلك خطوط إنتاج متقدمة عالية الكفاءة قادرة على تلبية احتياجات السوق المحلي والدولي
                                بجودة
    ...
    <section class="py-5" data-aos="fade-up">
        <div class="container">
            <div class="text-center mb-4" data-aos="fade-up">
                ...
                <h6 class="text-muted mt-3">
                    نلتزم بأعلى معايير الجودة والسلامة في جميع منتجاتنا، وقد حصلنا على العديد من الشهادات والاعتمادات
                    الدولية
                </h6>
            </div>
